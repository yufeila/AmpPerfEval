 ...
 * @LastEditTime: 2025-07-08 09:39:17
...
然而，现在又出现新的问题。
当我在基本测量状态下，输入为1kHz，电压范围在(0,1V)之间变化的正弦波时，FFT结果大致能稳定在0.50V左右，比较精确，输入为1kHz，电压范围在(0,2V)之间变化的正弦波时，FFT结果大致能稳定在0.837V左右，
问题：
1. FFT的精度还是过低，
2. 但是总有一个瞬间(3~5次显示)会跳转到0附近，我不知道这是为什么？是不是采样点数太少(1024个点)，不能涵盖整个正弦波周期？
