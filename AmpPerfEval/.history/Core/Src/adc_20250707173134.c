...
void MX_ADC1_Init(void)
{
  ...
  */
  ...
  hadc1.Init.ContinuousConvMode = ENABLE;  // Changed from DISABLE to ENABLE for continuous conversions
...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    */
    ...
    hdma_adc1.Init.Mode = DMA_CIRCULAR; // Changed from DMA_NORMAL to DMA_CIRCULAR for continuous DMA
