...
void MX_ADC1_Init(void)
{
  ...
  */
  ...
  hadc1.Init.ContinuousConvMode = ENABLE;  // Change to continuous conversion mode for continuous data
...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    */
    ...
    hdma_adc1.Init.Mode = DMA_CIRCULAR; // Change DMA mode to circular for continuous data transfer
