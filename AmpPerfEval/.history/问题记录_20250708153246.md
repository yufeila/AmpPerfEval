 ...
 * @LastEditTime: 2025-07-08 15:31:58
...
问题：
1. 背景：我接入了扫频输入，输入信号的频率就是各个频率点，输入的信号幅度应该在1V附近，但可能随着频率的变化而变化。
串口输出如下：
...
SWEEP[18]: Set=1397.2Hz, Measured=1000.0Hz/1000.0Hz, Vin=1.513V, Vout=1.512V, Gain=-0.00dB, Fs=100
...
SWEEP[38]: Set=31089.6Hz, Measured=999.8Hz/999.8Hz, Vin=0.981V, Vout=0.981V, Gain = 0.00dB, Fs = 106061Hz
