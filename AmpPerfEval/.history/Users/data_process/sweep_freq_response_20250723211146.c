...
void Fault_Detection(void)
{
    ...
    // 5. 判断正常范围
    if (gain < NORMAL_GAIN_AT_1K - NORMAL_GAIN_RANGE 
    || gain > NORMAL_GAIN_AT_1K + NORMAL_GAIN_RANGE
    || R_in < NORMAL_R_IN_AT_1K - NORMAL_R_IN_RANGE
    || R_in > NORMAL_R_IN_AT_1K + NORMAL_R_IN_RANGE
    || output_amp < NORMAL_VOUT_AC_AT_1K - NORMAL_VOUT_AC_RANGE
    || output_amp > NORMAL_VOUT_AC_AT_1K + NORMAL_VOUT_AC_RANGE)
    {
        // 故障
    }
