...
void Basic_Measurement_Page_Init()
{
    ...
    LCD_ShowString(0, 30, 240, 16, 16,"input signal");

    // 显示数据
    POINT_COLOR = DATA_COLOR;
    LCD_ShowString(0, 50, 100, 12, 12,"Vin:");
    LCD_ShowString(0, 70, 100, 12, 12,"Vs:");
    LCD_ShowString(0, 90, 100, 12, 12,"fs:");
    LCD_ShowString(0, 110, 100, 12, 12,"Rin:");

    // 显示副标题
    POINT_COLOR = SUBTITLE_COLOR;
    LCD_ShowString(0, 130, 240, 16, 16,"output signal(ac)");

    // 显示数据
    POINT_COLOR = DATA_COLOR;
    LCD_ShowString(0, 150, 100, 12, 12,"Vout(Open):");
    LCD_ShowString(0, 170, 100, 12, 12,"Vout(RL):");
    LCD_ShowString(0, 190, 100, 12, 12,"fs:");
    LCD_ShowString(0, 210, 100, 12, 12,"Rout:");

    // 显示副标题
    POINT_COLOR = SUBTITLE_COLOR;
    LCD_ShowString(0, 130, 240, 16, 16,"Vout(dc):");
