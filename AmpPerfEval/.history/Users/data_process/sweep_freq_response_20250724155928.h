 ...
 * @LastEditTime: 2025-07-24 15:59:28
...
#define FREQ_START_FAULT_DETECTION 1000.0f
#define FREQ_STOP_FAULT_DETECTION 200000.0f
#define FREQ_POINTS_FAULT_DETECTION 30
...
// 电路相关参数定义
#define V_s                     21.6f //单位：mV
#define V_Rs_Gain               100.0f
...
#define NORMAL_VOUT_AC_AT_1K 1.0f  // 单位: V
#define NORMAL_VOUT_AC_RANGE 0.1f  // 单位: V

#define R_Gain_Variance_Threshold 0.1f
#define C_Gain_Variance_Threshold 0.1f

#define R_FAULT_TYPE 1
#define C_FAULT_TYPE 2
#define NO_FAULT_TYPE 0
