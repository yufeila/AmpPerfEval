...
void Basic_Measurement(void)
{
    ...
    if(measure_r_out_flag)
    {
        ...
        {
            Process_ADC_Data_F32(&v_out_with_load[i].adc_in_Result, 
                               &v_out_with_load[i].adc_ac_out_Result, 
                               &v_out_with_load[i].adc_dc_out_Result, current_fs);
        }
