...
{
    static uint8_t ad9851_initialized = 0;  // 初始化标志
    ...
    if (!ad9851_initialized) {
        ...
        HAL_GPIO_WritePin(AD9851_FQ_UP_GPIO_PORT, AD9851_FQ_UP_PIN, GPIO_PIN_RESET);
        HAL_GPIO_WritePin(AD9851_RESET_GPIO_PORT, AD9851_RESET_PIN, GPIO_PIN_RESET);
        HAL_GPIO_WritePin(AD9851_BIT_DATA_GPIO_PORT, AD9851_BIT_DATA_PIN, GPIO_PIN_RESET);
